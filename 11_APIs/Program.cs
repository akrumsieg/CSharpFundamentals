...
namespace _11_APIs
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            HttpResponseMessage response = httpClient.GetAsync("https://swapi.dev/api/people/1").Result; //.GetAsync returns Task so we should use .Result
            ...
            Person personTwo = swapiService.GetPersonAsync(11).Result;
            if (personTwo != null)
            {
            ...
            else Console.WriteLine("No vehicle exists here.");
