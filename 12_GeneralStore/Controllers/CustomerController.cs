...
namespace _12_GeneralStore.Controllers
{
    public class CustomerController : ApiController
    {
        ...
        [HttpPost] //data annotations not required, but helpful. Best practice. DO IT
        ...
        [HttpGet]
        public async Task<IHttpActionResult> GetById([FromUri] int id) //FromUri is not necessary but can protect from certain use cases
        {
